export const ARTICLE_CREATE_REQUEST = "ARTIC_CREATE_REQUEST";
export const ARTICLE_CREATE_SUCCESS = "ARTIC_CREATE_SUCCESS";
export const ARTICLE_CREATE_FAIL = "ARTI_CREATE_FAIL";
...
export const ARTICLE_LIST_FAIL = "ARTICL_LIST_FAIL";
